namespace proje_ErdalBakkal.stok
{
	partial class frmStokListe
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmbEgitim = new DevExpress.XtraEditors.ComboBoxEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.cmbEgitim.Properties)).BeginInit();
			...
			// cmbEgitim
			// 
			this.cmbEgitim.EditValue = "Aktif Stok Listesi";
			this.cmbEgitim.Location = new System.Drawing.Point(532, 5);
			this.cmbEgitim.Name = "cmbEgitim";
			this.cmbEgitim.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.cmbEgitim.Properties.Items.AddRange(new object[] {
            "Pasif Stok Listesi",
            "Aktif Stok Listesi",
            "Tüm Stokları Listele"});
			this.cmbEgitim.Size = new System.Drawing.Size(160, 20);
			this.cmbEgitim.TabIndex = 14;
			this.cmbEgitim.SelectedIndexChanged += new System.EventHandler(this.cmbEgitim_SelectedIndexChanged);
			// 
			// btnEkle
			// 
			...
			this.gcListe.Size = new System.Drawing.Size(836, 382);
			...
			// panelControl2
			// 
			this.panelControl2.Controls.Add(this.cmbEgitim);
			...
			this.panelControl2.Size = new System.Drawing.Size(836, 31);
			...
			((System.ComponentModel.ISupportInitialize)(this.cmbEgitim.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.ComboBoxEdit cmbEgitim;
